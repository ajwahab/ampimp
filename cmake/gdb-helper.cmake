...
#---------------------------------------------------------------------------------------
# Generates a GDB run script for debugging with any supported programmer and JLink.
#---------------------------------------------------------------------------------------
function(generate_run_gdb_jlink TARGET)
    get_target_property( BINARY_NAME ${TARGET} OUTPUT_NAME )
    get_target_property( TARGET_NAME ${TARGET} NAME )
    # GDB commands to connect to GDB target
    configure_file(${CURRENT_MODULE_DIR}/jlink-run.gdb.in ${PROJECT_BINARY_DIR}/jlink-run.gdb @ONLY)
    # Alt GDB commands to debug after a connection has been established (e.g. when using CLion remote GDB)
    configure_file(${CURRENT_MODULE_DIR}/jlink-conf.gdb.in ${PROJECT_BINARY_DIR}/${TARGET}-gdb.gdb @ONLY)
endfunction()