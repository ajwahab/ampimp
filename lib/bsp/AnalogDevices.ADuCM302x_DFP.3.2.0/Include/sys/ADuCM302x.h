...
#define BITP_CLKG_CLK_CTL0_CLKOUT             3            /*  GPIO Clock Out Select (for Debug) */
...
#define BITM_CLKG_CLK_CTL0_CLKOUT            (_ADI_MSK_3(0x00000078,0x00000078UL, uint32_t  ))    /*  GPIO Clock Out Select (for Debug) */
